...
if (pselect5 != "exit") then
{
	...
	_name = pselect5;
	{
		...
		{
			["Info", format ["Téléportation sur %1", _name]] spawn life_fnc_showPredefinedNotification;

			[format ["%1 Se TP sur %2",profileName,_name], getPlayerUID player,7] remoteExecCall ["TON_fnc_logsAdmin",2];
