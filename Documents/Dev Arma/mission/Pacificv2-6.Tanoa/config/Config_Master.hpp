...
class Life_Settings {
    ...
    cops_online_min_littleBank = 5; //minimum cops online for robbing a bank
    cops_online_min_littleBankSimple = 5; //minimum cops online for robbing a bank
    ...
    // Gangs
    gang_flags[] = {"gang_zone_1", "gang_zone_2", "gang_zone_3", "gang_zone_7", "gang_zone_9"};
    gang_check_time = 30; // Minutes
    gang_check_distance = 500;

    addonsList[] = {"A3_Functions_F","A3_Data_F","A3_Data_F_ParticleEffects","A3_Dubbing_Radio_F","A3_Editor_F","A3_Functions_F_Curator","A3_Language_F","A3_Modules_F_DynO","A3_Modules_F_Beta_FiringDrills","A3_Music_F","A3_Structures_F","A3_Structures_F_Mil_Flags","A3_Animals_F","A3_Animals_F_Fishes","A3_Animals_F_Rabbit","A3_Animals_F_Snakes","A3_Animals_F_Turtle","A3_Animals_F_Beta_Chicken","A3_Animals_F_Beta_Dog","A3_Animals_F_Beta_Goat","A3_Animals_F_Beta_Sheep","A3_Anims_F_Config_Sdr","A3_Map_Stratis","A3_Ui_F","A3_Ui_F_Curator","A3_Weapons_F","A3_Characters_F_Heads","A3_Data_F_Curator","A3_Data_F_Kart_ParticleEffects","A3_Map_Altis","A3_Missions_F","A3_Modules_F_Kart_TimeTrials","A3_Sounds_F","A3_Static_F","A3_Ui_F_Kart","A3_Weapons_F_Acc","A3_Data_F_Bootcamp","A3_Data_F_Mark","A3_Functions_F_MP_Mark","A3_Missions_F_EPA","A3_Modules_F_MP_Mark_Objectives","A3_Ui_F_MP_Mark","A3_Weapons_F_Mark","A3_Anims_F_Mark_Deployment","A3_Data_F_Exp_B","A3_Ui_F_Exp_A","A3_3DEN","A3_Data_F_Exp_ParticleEffects","A3_Dubbing_Radio_F_EXP","A3_Missions_F_Bootcamp","A3_Missions_F_Heli","A3_Weapons_F_Exp","A3_Map_Tanoabuka"};
...
#include "Config_Resource_Zones.hpp"
#include "Config_Entreprise.hpp"
#include "Config_LittleBank.hpp"
#include "Config_LittleBankSimple.hpp"
...
#include "Config_Smart_Markers.hpp"

#include "Config_Illegal.hpp"
#include "Config_CaseMoney.hpp"
#include "Config_Caches.hpp"
#include "Config_Dlc.hpp"
#include "Config_Insurge.hpp"
#include "Config_Narcos.hpp"
#include "Config_Effect.hpp"
#include "Config_GarageCommon.hpp"
#include "Config_Bank.hpp"
