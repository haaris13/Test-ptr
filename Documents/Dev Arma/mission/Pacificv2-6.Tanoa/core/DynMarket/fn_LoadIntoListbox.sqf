...
if (isNil "DYNMARKET_prices") then {
	...
	["Info", "Obtention des prix actuels du serveur..."] spawn life_fnc_showPredefinedNotification;
	sleep 1;
	};
...
_blacklist =
[
	"redgull","rabbit","tbacon","lockpick", "pickaxe", "axe", "shovel", "cut", "fuelFull","storagesmall",
	"bakedbeans","rice","cereals","franta","spirit",
	"storagebig","donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "defusekit"
];
