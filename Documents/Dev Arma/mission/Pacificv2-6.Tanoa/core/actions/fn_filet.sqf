...
if (ITEM_VALUE("filet") isEqualTo 0) exitWith {["Error", "Vous avez besoin d'un Filet !"] spawn life_fnc_showPredefinedNotification;};
...
if (["farmerV2"]call life_fnc_hasPerk) then {
