...
//if ((_config isEqualTo "log") && (!license_civ_logging)) exitWith {["Error", "Vous avez besoin d'une licence de bûcheron pour couper ici !"] spawn life_fnc_showPredefinedNotification;};
