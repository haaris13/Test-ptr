...
if ((count life_bulletsPlayerZone) > 0) exitWith {
	...
	["Accepted", "Travers sur zone Désactivé."] spawn life_fnc_showPredefinedNotification;
...
showBulletZone = {
	...
	openMap [false, false];
	["Accepted", format["Travers activé sur cette zone (100m)! Pour %1 Unités !", (count life_bulletsPlayerZone)]] spawn life_fnc_showPredefinedNotification;
