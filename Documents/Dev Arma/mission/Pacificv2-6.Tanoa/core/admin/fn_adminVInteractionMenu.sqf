...
//Set Repair Action
_Btn1 ctrlSetText "Réparer & Essence";
_Btn1 buttonSetAction "life_vInact_curTarget setDamage 0; life_vInact_curTarget setFuel 1; closeDialog 0; [format [""%1 Repair / Essence Admin %2"",profileName,life_vInact_curTarget_name], getPlayerUID player, 5] remoteExecCall [""TON_fnc_logsAdmin"",2];";
...
_Btn5 ctrlSetText "Débug Coffre";
_Btn5 buttonSetAction "life_vInact_curTarget setVariable['trunk_in_use',false,true]; life_vInact_curTarget setVariable['trunk_cache_use',false,true]; closeDialog 0; [format [""%1 Débug Coffre Admin %2"",profileName,life_vInact_curTarget_name], getPlayerUID player, 5] remoteExecCall [""TON_fnc_logsAdmin"",2];";

_Btn6 ctrlSetText "Monter";
_Btn6 buttonSetAction "player moveInAny life_vInact_curTarget;";

_Btn7 ctrlSetText "Activer la Balise";
_Btn7 buttonSetAction "[player, life_vInact_curTarget] remoteExec ['TON_fnc_depanLaunchBalise', 2]; closeDialog 0;";
