...
if(EQUAL(count _containerInfo,0)) exitWith {["Error", localize "STR_Cop_ContainerEmpty"] spawn life_fnc_showPredefinedNotification;};
...
if(_value > 0) then {
	...
	["Error", localize "STR_Cop_NoIllegalCOntainer"] spawn life_fnc_showPredefinedNotification;
};
