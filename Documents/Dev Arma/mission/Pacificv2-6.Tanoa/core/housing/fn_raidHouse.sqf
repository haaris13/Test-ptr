...
if(_houseInv isEqualTo [[],0]) exitWith {["Error", localize "STR_House_Raid_Nothing"] spawn life_fnc_showPredefinedNotification;};
...
if(_value > 0) then {
	...
	["Error", localize "STR_House_Raid_NoIllegal"] spawn life_fnc_showPredefinedNotification;
};