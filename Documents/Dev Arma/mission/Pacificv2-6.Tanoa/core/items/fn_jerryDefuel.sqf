...
if((Fuel _vehicle) <= (20 / _fuelCapacity)) exitWith {["Error", "Pas assez de carburant dans le réservoir."] spawn life_fnc_showPredefinedNotification;};
...
if((Fuel _vehicle) <= (20 / _fuelCapacity)) exitWith {["Error", "Il n'y a plus assez de carburant dans le réservoir!"] spawn life_fnc_showPredefinedNotification;};
