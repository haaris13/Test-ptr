...
//if (playerSide == civilian) exitWith {["Error", "Un civil ne peut pas placer cette objet."] spawn life_fnc_showPredefinedNotification;};

if (playerSide == civilian && life_playerlevel < 2) exitWith {
	closeDialog 0;
	["Error", "Vous n'êtes pas niveau 2 !"] spawn life_fnc_showPredefinedNotification;
};
