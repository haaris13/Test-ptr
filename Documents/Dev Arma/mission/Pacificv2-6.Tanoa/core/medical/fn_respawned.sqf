...
{
	case west: {
	//loads sync'd gear so cops keep gear after deaths
	//Hotfix for some stupid fucking bug, until I redo this
...
if(life_is_arrested) exitWith {
	["Error", localize "STR_Jail_Suicide"] spawn life_fnc_showPredefinedNotification;
...
//So I guess a fellow gang member, cop or myself killed myself so get me off Most Wanted
