...
if !(isnil {_vehicle getVariable "clan_group"}) exitWith {["Error", "Vous ne pouvez pas donner ces clefs !"] spawn life_fnc_showPredefinedNotification;};
if !(isnil {_vehicle getVariable "clan_inventory"}) exitWith {["Error", "Vous ne pouvez pas donner ces clefs !"] spawn life_fnc_showPredefinedNotification;};
