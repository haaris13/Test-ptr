...
if(isNil "_data") exitWith {["Error", "Failed to fetch crimes"] spawn life_fnc_showPredefinedNotification;};
if(typeName _data != "ARRAY") exitWith {["Error", "Failed to fetch crimes"] spawn life_fnc_showPredefinedNotification;};
if(count _data == 0) exitWith {["Error", "Failed to fetch crimes"] spawn life_fnc_showPredefinedNotification;};
lbClear _list;
