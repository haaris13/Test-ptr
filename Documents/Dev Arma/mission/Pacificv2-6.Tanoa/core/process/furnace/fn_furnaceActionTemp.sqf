...
if(_value < 100) exitWith {["Error", "La Température doit être comprise entre 100°C et 8000°C !"] spawn life_fnc_showPredefinedNotification;};
if(_value > 8000) exitWith {["Error", "La Température doit être comprise entre 100°C et 8000°C !"] spawn life_fnc_showPredefinedNotification;};
