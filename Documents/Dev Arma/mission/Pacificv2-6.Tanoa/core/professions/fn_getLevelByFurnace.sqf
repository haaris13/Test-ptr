...
_zoneExp = getArray (missionConfigFile >> "CfgFurnace" >> _configProcess >> "zoneExp");
_prof = getText (missionConfigFile >> "CfgFurnace" >> _configProcess >> "Profession");
_factor = getNumber(missionConfigFile >> "CfgFurnace" >> _configProcess >> "Professionfactor");
