/*
	File: fn_fireworksLaunch.sqf

	Autor: IronBlade
*/

if (isDedicated) exitWith { diag_log "Server ! GRAD_Fireworks !"; };

_firing_position = [_this,0,[],[[]]] call BIS_fnc_param;
_type1 = [_this,1,"",[""]] call BIS_fnc_param;
_initial_velocity = [_this,2,[],[[]]] call BIS_fnc_param;
_explosion_power = [_this, 3, 0, [0]] call BIS_fnc_param;
_glitter_count = [_this, 4, 0, [0]] call BIS_fnc_param;

_color = [_this,5,[],[[]]] call BIS_fnc_param;
_explosion_fragments_array = [_this,6,[],[[]]] call BIS_fnc_param;
_explosion_subfragments_array = [_this,7,[],[[]]] call BIS_fnc_param;
...
if (player distance _firing_position > 5000) exitWith {};
