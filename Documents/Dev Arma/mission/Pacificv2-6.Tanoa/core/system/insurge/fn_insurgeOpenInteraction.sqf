/*
	File: fn_insurgeOpenInteraction.sqf
...
createDialog "Insurge_Interaction";
...
_button buttonSetAction format["closeDialog 0; [] spawn life_fnc_insurgeOpenDeposeCash;"];

_button = _buttons select _indexButton;
_indexButton = _indexButton + 1;

_button ctrlSetText "Progression";
_button buttonSetAction format["closeDialog 0; [] spawn life_fnc_insurgeOpenProgress;"];

_button = _buttons select _indexButton;
_indexButton = _indexButton + 1;

_button ctrlSetText "Historique";
_button buttonSetAction format["closeDialog 0; [player] remoteExec ['TON_fnc_insurgeFindClanStats', 2];"];
