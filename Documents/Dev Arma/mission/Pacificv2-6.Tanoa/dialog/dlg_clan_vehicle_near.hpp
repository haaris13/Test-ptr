class Dialog_Clan_Veh_Near
{
	...
	class controls
	{
		...
		{
			idc = 6802;
			onLBSelChanged = "_this call life_fnc_clanVehicleStoreMenuLb;";
			rowHeight = 0.1;
			sizeEx = 0.03;
			x = 0.407187 * safezoneW + safezoneX;
		...
		{
			onButtonclick = "[] call life_fnc_clanVehicleStoreMenuAction;";
