...
class Dialog_gouv_lois_mod {
	...
	class controls {
		...
		class Title: Life_RscTitle
		{
			...
			text = "Gestion des Lois"; //--- ToDo: Localize;
		...
		class loisList: Life_RscListBox
		{
			...
			onLBSelChanged = "_this call life_fnc_gouvLoisLbMod;";
		...
		{
			onButtonClick = "[] spawn life_fnc_gouvLoisDelete;";
			idc = 9603;
		...
		{
			onButtonClick = "[] spawn life_fnc_gouvOpenLoisCreate";
			idc = 9604;

			text = "Nouvelle"; //--- ToDo: Localize;
