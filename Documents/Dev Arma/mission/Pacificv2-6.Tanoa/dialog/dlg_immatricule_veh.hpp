class Immatricule_Veh
{
	...
	class controlsBackground
	{
		...
		class RscTitleBackground: Life_RscText
		{
			...
			text = "Immatriculation"; //--- ToDo: Localize;
	...
	class controls
	{
		...
		{
			idc = 71402;
			onLBSelChanged = "_this call life_fnc_immatriculeVehSelection";
			rowHeight = 0.1;
			sizeEx = 0.03;
			x = 0.407187 * safezoneW + safezoneX;
		...
		{
			onButtonclick = "[] call life_fnc_initImmatricule;";
