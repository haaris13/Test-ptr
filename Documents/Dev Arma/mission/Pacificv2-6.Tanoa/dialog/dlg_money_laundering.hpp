class MoneyLaunderingDialog
{
	...
	class controlsBackground
	{
		class RscTitleBackground: Life_RscText
		{
			...
			text = "Blanchiement"; //--- ToDo: Localize;
	...
	class Controls
	{
		...
		{
			idc = 16301;
			onLBSelChanged = "_this call life_fnc_invoiceMoneyLaunderingMenuLbChange";
			rowHeight = 0.09;
		...
		{
			onButtonclick = "[] spawn life_fnc_invoiceMoneyLaunderingMenuAction;";
			idc = 16303;

			text = "Blanchir"; //--- ToDo: Localize;
