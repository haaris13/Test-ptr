...
class life_admin_show
{
	name = "life_admin_show";
	idd = 38400;
	fadein=0;
	duration = 99999999999;
	fadeout=0;
	movingEnable = 0;
	onLoad="uiNamespace setVariable ['life_admin_show', _this select 0]";
	objects[]={};
	...
	class controlsBackground
	{
		class background : Life_RscText
		{
			...
			w = 0.149531 * safezoneW; h = 0.319 * safezoneH;
		};
		...
		class InfoText : Life_RscStructuredText
		{
			...
			w = 0.139219 * safezoneW; h = 0.297 * safezoneH;
		};
	};
};