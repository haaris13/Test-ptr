class Veh_Trans_Select_Player
{
	...
	class controls
	{
		...
		{
			idc = 74402;
			onLBSelChanged = "_this call life_fnc_transfertVehPlayerLbChange";
			rowHeight = 0.1;
			sizeEx = 0.03;
			x = 0.407187 * safezoneW + safezoneX;
		...
		{
			onButtonclick = "[] call life_fnc_transfertVehPlayerValid;";
