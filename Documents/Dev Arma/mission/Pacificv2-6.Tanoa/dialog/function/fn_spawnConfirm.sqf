...
if (playerSide isEqualTo west) then {
	...
	if (_cGear isEqualTo _buggedGear) then {
		[]spawn {
			["Error", "Une erreur est survenue pendant la récupération de votre personnage. Veuillez créer un ticket pour signaler votre problème au staff et envoyer votre fichier RPT."] spawn life_fnc_showPredefinedNotification;;
