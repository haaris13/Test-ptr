...
this addAction["Achat d'equipements",life_fnc_weaponShopMenu,"depan_basic",0,false,false,"",'playerSide == civilian && ((call life_depanLevel) > 0)'];
this addAction["Achat de vétements",life_fnc_clothingMenu,"depan",0,false,false,"",'playerSide == civilian && ((call life_depanLevel) > 0)'];
this addAction["Marché",life_fnc_virt_menu,"depan",0,false,false,"",'playerSide == civilian && ((call life_depanLevel) > 0)'];