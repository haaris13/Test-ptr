...
class CfgHints
{
	class Farm
	{
		...
		class Recolte
		{
			...
			description = "Pour récolter des ressources il suffit d'appuyer sur la touche Windows à proximité d'une zone de récolte.";
    ...
    class Action
    {
        ...
        class Commencer
        {
            ...
            description = "Bonjour, et Bienvenue sur l'île, je me présente je suis Jarvis, je vais vous aider tout au long de votre aventure !%1%1Plus d'infos sur %3<a href='test.com'>site test</a>%4";
        ...
        class Capture
        {
            ...
            description = "Les Drapeaux définissent les propriétaires des zones.%1Le temps de capture est définit par les joueurs dans la zone:%1%2Les membres de votre propre gang.%1%2Les gangs rivaux%1%2Les autres groupes.%1%1Si une zone est abandonnée par ces membres elle retourne à la Gendarmerie.";
        ...
        class Kaelevra
        {
            ...
            description = "Bienvenue au restaurant %3le Kaelevra%4 nous vous proposons une gastronomie venant des quatre coins du monde.%1Donc Vous avez:%1%2Sushi de Sardine 5.000€%1%2Assiette Grecque 7.500€%1%2Paella 10.000€%1%2Assiette de riz cantonais 25.000€%1%2Tajin 100.000€%1%2Tartiflette 200.000€ (rupture de stock )%1%2Plat du jour 250.000€%1%2Tacos 500.000€%1%1Carte des Alcools:%1%2Bière 1.000€ ( Rupture de Stock )%1%2Vins Rouge 10.000€ ( Rupture de Stock )%1%2Verres de Saké 20.000€%1%2Vodka Żubrówka 50.000€ ( Rupture de Stock )%1%2Bouteilles de rhum 100.000€%1%2Bouteilles de champagne 125.000 ( Rupture de Stock )€%1%1En espérant que vous avez passé un agréable moment !";
        ...
        {
            displayName = "L'entrainement au maniement des armes";

            description = "Il faut vous entraîner au %3stand d'entrainement%4 si vous voulez vous améliorer au maniement de votre arme, vous pouvez voir votre niveau sur un stand.";
    ...
    class Prof
    {
        ...
        class Global
        {
            ...
            tip = "Pour vous améliorer dans une profession il suffit de réaliser des actions dans le domaine de la profession.";
    ...
    class LittleBank
    {
        displayName = "Banques de Tanoa";

        class BraquerBanque
        {
            displayName = "La Banque de Tanoa";

            description = "La Banque de Tanoa est un moyen simple de ce faire de l'argent.%1Comment Faire:%1%2Il vous faut une charge.%1%2Aller lancer %3l'action sur la porte%4.%1%2Attendre la fin du décompte.%1%2%3Disquer%4 la seconde porte.%1%2Vider le coffre.%1%2Ne Pas Mourir.%1%1Attention si vous voulez une grosse somme d'argent il faut que tous les membres de votre groupe soient à moins de 35m de la porte tout au long de l'action !";
    ...
    class Immatriculation
    {
        ...
        class Legale
        {
            ...
            description = "Ici vous pouvez immatriculer vos véhicules de manière légale.%1Les Immatriculations légales vous permettent de voyager librement dans l'île, par contre si vous effectuez une infraction un joueur pourra vous dénoncer à la gendarmerie.%1 Votre Immatriculation est unique et donc ne peut pas être reproduite légalement%1La Gendarmerie dispose d’un moyen d’identifier le propriétaire d'une plaque légale.";

            tip = "Les plaques d'Immatriculation sont constituées obligatoirement de 9 caractères.%1Les Insultes sont interdites !";
        ...
        class Illegal
        {
            ...
            description = "Ici vous pouvez immatriculer vos véhicules de manière illégale.%1Les Immatriculations illégales vous permettent de voyager incognito dans l'ile, par contre si la Gendarmerie cherche dans leurs ordinateurs le numéro de votre plaque il est possible, si il n’est pas attribué légalement à un véhicule du même type que vous soyez découvert et arrêté.";

            tip = "Les plaques d'Immatriculation sont constituées obligatoirement de 9 caractères.%1Il est impossible pour un même joueurs de posséder deux fois la même plaque d'immatriculation.%1Les Insultes sont interdites !";
    ...
    class Licences
    {
        ...
        class insurge
        {
            displayName = "Entrainement Narcos";

            description = "Cette licence permet d'acheter des armes, vehicules, vétements et de débloquer des zones d'apparition Narcos.";
        ...
        class sejour
        {
            ...
            description = "Cette licence permet d'apparaitre dans les villes controlées par l'état";
        ...
        class mafia
        {
            ...
            description = "Cette licence permet d'acheter des armes, vehicules, vétements Mafieux.";
