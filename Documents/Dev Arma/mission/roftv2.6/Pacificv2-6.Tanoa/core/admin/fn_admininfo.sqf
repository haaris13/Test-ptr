...
if ((getPlayerUID player) in ["76561198059757685","76561198118138558","76561198045934831", "76561198158111814"]) then {
	CONTROL(2900,2903) ctrlSetStructuredText parseText format["<t size='.8'>Name: %1<br/>Steam Name: %10<br/>Player UID: %11<br/>Marker: %13<br/>Player Side: %12<br/>Bank: %2<br/>Money: %3<br/>Uniform: %4<br/>Vest: %5<br/>Backpack: %6<br/>Primary: %7<br/>Handgun: %8<br/><t align='center'>Primary Attachments</t><br/>%9</t>",
	_unit GVAR ["realname",name _unit],[SEL(_ret,0)] call life_fnc_numberText,[SEL(_ret,1)] call life_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach,_steamName,SEL(_ret,5),SEL(_ret,6),_unit getVariable ["life_markers",false]];
} else {
