...
if (coffre_bank getVariable ["chargeplaced",false]) then {
	["InfoWithSound", "Désamorçage en cours"] spawn life_fnc_showPredefinedNotification;
...
if (coffre_bank getVariable ["open",false]) then {
	["InfoWithSound", "Fermeture du coffre"] spawn life_fnc_showPredefinedNotification;
...
["Warning", "Alarme activée !"] spawn life_fnc_showPredefinedNotification;