...
["Warning", localize "STR_Jail_LicenseNOTF"] spawn life_fnc_showPredefinedNotification;
...
if (!_bad) then {
	...
	_amountBank = (life_atmbank * 0.3);

	_message = "La prise en charge de votre incarcération est équivalent à 30% de votre compte en banque !";
...
} forEach ["mauiwaui_unprocessed","mauiwaui_processed","cannabis","marijuana","purple_unprocessed","purple_processed","turtle_raw"];
