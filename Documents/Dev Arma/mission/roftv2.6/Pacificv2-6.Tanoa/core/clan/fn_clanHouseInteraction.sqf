...
if !((_curTarget getVariable "clan_group") isEqualTo _group) exitWith {["Error", "Cette Maison de clan appartient a un autre clan !"] spawn life_fnc_showPredefinedNotification;};
...
if (isNil {_curTarget getVariable "clan_group"}) then {
	...
	_Btn1 ctrlSetText "Acheter une Maison Clan";
