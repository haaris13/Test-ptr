...
switch (typeOf _vehicle) do {
	...
	case "C_Offroad_02_unarmed_F": {
		_lightLeft lightAttachObject [ _vehicle, [ -0.37, -0.8, 0.50 ] ];
		_lightRight lightAttachObject [ _vehicle, [ 0.37, -0.8, 0.50 ] ];
	};
...
[_lightLeft] spawn life_fnc_deleteVehicle;
[_lightRight] spawn life_fnc_deleteVehicle;