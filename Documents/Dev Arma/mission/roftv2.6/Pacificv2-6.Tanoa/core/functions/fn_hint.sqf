/*
	...
	Description:
		- Displays a message, with extra customization
		
	Use: 
		[1, "MessageBody", ["MessageTitle", "#ffd11a"]] call life_fnc_hint;
...
if (count _messageTitle > 0) then {
	...
	_messageTitleText = [_messageTitle, 0, "Message", [""]] call BIS_fnc_param;
