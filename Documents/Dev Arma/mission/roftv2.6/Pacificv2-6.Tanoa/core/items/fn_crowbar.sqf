...
if (playerSide == civilian) exitWith {["Error", "Vous ne pouvez pas utiliser cette objet."] spawn life_fnc_showPredefinedNotification;};
...
titleText ["Vous avez désormais accès à ce véhicule", "PLAIN"];
