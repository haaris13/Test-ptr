...
_spikeStrip = "wirk_spikes" createVehicle [0,0,0];
...
[_spikeStrip,  [(getPos _spikeStrip select 0),(getPos _spikeStrip select 1),0]] call KK_fnc_setPosAGLS;
...
' _spikes = nearestObjects[getPos player,["wirk_spikes"],8] select 0; !isNil "_spikes" && !isNil {(_spikes getVariable "item")}'];
*/
