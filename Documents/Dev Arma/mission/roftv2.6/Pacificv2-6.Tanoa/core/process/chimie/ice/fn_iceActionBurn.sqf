...
if (_amount == 0) exitWith { ["Error", "La fiole est vide !"] spawn life_fnc_showPredefinedNotification;};

if(_value < 10) exitWith {["Error", "La Température doit être comprise entre 10°C et 130°C !"] spawn life_fnc_showPredefinedNotification;};
if(_value > 130) exitWith {["Error", "La Température doit être comprise entre 10°C et 130°C !"] spawn life_fnc_showPredefinedNotification;};
if(_value <= _temp) exitWith {["Error", "Vous pouvez uniquement chauffer !"] spawn life_fnc_showPredefinedNotification;};
