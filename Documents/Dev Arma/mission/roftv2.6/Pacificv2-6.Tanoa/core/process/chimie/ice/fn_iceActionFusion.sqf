...
if (((life_iceChimie_fiole select 0) select 0) == 0) exitWith {["Error", "Une des fioles est vide !"] spawn life_fnc_showPredefinedNotification;};
if (((life_iceChimie_fiole select 1) select 0) == 0) exitWith {["Error", "Une des fioles est vide !"] spawn life_fnc_showPredefinedNotification;};
