...
if (count _result == 0) exitWith {["Error", "Ce fluide est irrécuparable dans cette état !"] spawn life_fnc_showPredefinedNotification;};
...
if (_resultItem == "") exitWith {["Error", "Ce produit est trop mauvais pour être récupéré !"] spawn life_fnc_showPredefinedNotification;};
