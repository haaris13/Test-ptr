...
_var_prof_narcos = (missionNamespace getVariable ["prof_narcos",0]);
...
if (_var_prof_craft != 0 || _var_prof_narcos != 0 || _var_prof_mining != 0 || _var_prof_treasure != 0) exitWith {};
...
_var_prof_narcos = round((96.731 * ln(life_atmbank)) - 1092.1);
...
if (_var_prof_narcos > 750) then {
	_var_prof_narcos = 750;
};
...
missionNamespace setVariable ["prof_narcos", _var_prof_narcos];
