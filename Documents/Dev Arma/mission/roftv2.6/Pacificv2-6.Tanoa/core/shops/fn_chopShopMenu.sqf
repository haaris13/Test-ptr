...
if(!(createDialog "Chop_Shop")) exitWith {["Error", localize "STR_Shop_ChopShopError"] spawn life_fnc_showPredefinedNotification;};
...
_control = CONTROL(39400,39402);
{
	if(alive _x) then {
		...
		_price = M_CONFIG(getNumber,CONFIG_LIFE_VEHICLES,_classNameLife,"insurance");
