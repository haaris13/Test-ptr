...
if (!isClass (_cfgAchievement >> _achievement)) exitWith {diag_log format["%1 is no CfgAchievement class", _achievement];};
...
_displayname = format["<t size='0.9' font='PuristaBold'>Succès Déverrouillé</t><br/><t size='0.8' font='PuristaLight'>%1</t>", _displayname];
