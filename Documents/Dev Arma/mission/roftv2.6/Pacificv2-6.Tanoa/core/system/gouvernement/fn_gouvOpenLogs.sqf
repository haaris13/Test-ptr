...

{
	...
	switch (_type) do {
		case 0 : {
			_type = "Dépots Compte Gouvernemental";
		...
		case 2 : {
			_type = "Transfert Compte Gouvernemental --> Compte Gendarmerie";
			_color = [0.937,0.306,0.286,1];
		};

		case 3 : {
			_type = "Dépots Compte Gendarmerie";
			_color = [0.055,0.184,0.267,1];
		};

		case 4 : {
			_type = "Retrait Compte Gendarmerie";
			_color = [0.055,0.184,0.267,1];
		};
	};
