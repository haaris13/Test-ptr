...
["Warning", "Vous êtes sur le point de retirer la plaque d'immatriculation. Attention le véhicule deviendra illégale, vous ne pourez plus l'immatriculer de maniére légale !"] spawn life_fnc_showPredefinedNotification;
