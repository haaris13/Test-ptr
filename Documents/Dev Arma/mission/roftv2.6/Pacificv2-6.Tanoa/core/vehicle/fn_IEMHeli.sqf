...
if (life_iem_state == 0) then {
	...
	["<t color='#ff0000'>Attention, La Gendarmerie vous demande de vous poser ! (Ce n'est pas une Sommation !)</t>"] call life_fnc_dynamicText;
	...
	if ((vehicle player) getVariable ["brouilleurPlace",false]) exitWith {
		...
		["L'IEM n'a pas pu être lancé ! Un brouilleur est présent sur le vehicule !</t>"] remoteExecCall ["life_fnc_dynamicText",_cop];
	};
	...
	["<t color='#ff0000'>Attention, La Gendarmerie a lancé un IEM !</t>"] call life_fnc_dynamicText;
