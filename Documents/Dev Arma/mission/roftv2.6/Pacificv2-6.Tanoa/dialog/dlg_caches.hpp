class CacheMenu
{
	...
	class Controls
	{
		...
		class CacheWeight: Life_RscTitle
		{
			idc = 4104;
			style = 1;
		...
		class CacheGear: Life_RscListBox
		{
			onLBSelChanged = "[1] call life_fnc_cachesMenuLBChange;";
			idc = 4102;
				rowHeight = 0.1;
			sizeEx = 0.03;
		...
		{
			onLBSelChanged = "[0] call life_fnc_cachesMenuLBChange;";
			idc = 4103;
			rowHeight = 0.1;
			sizeEx = 0.03;
		...
		{
			onButtonClick = "[] call life_fnc_cachesTakeItem;";
		...
		{
			onButtonClick = "[] call life_fnc_cachesStoreItem;";
