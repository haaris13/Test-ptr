class Dialog_ClanHouseTrunkMenu
{
	idd = 6700;
	name = "Dialog_ClanHouseTrunkMenu";
	movingEnable = false;
	...
	class Controls
	{
		class filterCombo : Life_RscCombo
		{
			idc = 6709;
			rowHeight = 0.1;
			onLBSelChanged = "[] call life_fnc_clanHouseInv;";
		...
		{
			onLBSelChanged = "[1] call life_fnc_clanHouseInvMenuLBChange;";
			idc = 6702;
				rowHeight = 0.1;
			sizeEx = 0.03;
			x = 0.510312 * safezoneW + safezoneX;
		...
		{
			onLBSelChanged = "[0] call life_fnc_clanHouseInvMenuLBChange;";
			idc = 6703;
			rowHeight = 0.1;
			sizeEx = 0.03;
		...
		{
			onButtonClick = "[] call life_fnc_clanHouseInvTakeItem;";
		...
		{
			onButtonClick = "[] call life_fnc_clanHouseInvStoreItem;";
