	...
	class controls {
		...
		class controls {
				...
				class HeaderTile1Image: life_RscPicture
				{
					...
					text = "dialog\data\profs\icon_macguyver.paa"; //--- ToDo: Localize;
					x = 0.29375 * safezoneW + safezoneX;
					y = 0.269 * safezoneH + safezoneY;
					w = 0.0515625 * safezoneW;
					h = 0.077 * safezoneH;
				...
				class HeaderTile2mage: life_RscPicture
				{
					...
					text = "dialog\data\profs\icon_narcos.paa"; //--- ToDo: Localize;
					x = 0.520625 * safezoneW + safezoneX;
					y = 0.269 * safezoneH + safezoneY;
					w = 0.0515625 * safezoneW;
					h = 0.077 * safezoneH;
				...
				class HeaderTile5Image: life_RscPicture
				{
					...
					text = "dialog\data\profs\icon_contreband.paa"; //--- ToDo: Localize;
					x = 0.29375 * safezoneW + safezoneX;
					y = 0.493 * safezoneH + safezoneY;
					w = 0.0515625 * safezoneW;
					h = 0.077 * safezoneH;
				...
				class Tile5Title: Life_RscText
				{
					...
					text = "Contrebande"; //--- ToDo: Localize;
					x = 0.355625 * safezoneW + safezoneX;
				...
				class HeaderTile6Image: life_RscPicture
				{
					...
					text = "dialog\data\profs\icon_livreur.paa"; //--- ToDo: Localize;
					x = 0.520625 * safezoneW + safezoneX;
					y = 0.493 * safezoneH + safezoneY;
					w = 0.0515625 * safezoneW;
					h = 0.077 * safezoneH;
