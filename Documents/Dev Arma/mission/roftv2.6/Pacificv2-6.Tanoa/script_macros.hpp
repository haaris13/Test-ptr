...
#define REPUTATION life_reputation
#define PLAYERXP life_playerxp
#define PLAYERLEVEL life_playerlevel
...
#define PROFESSION_VARNAME(varName) format["%1",M_CONFIG(getText,"Professions",varName,"variable")]
#define PROFESSION_VALUE(varName) GVAR_MNS [PROFESSION_VARNAME(varName),0]
