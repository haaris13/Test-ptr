...
class Hack_system_V2_Console_Tuppy
{
	idd = 667;
	onKeyDown = "params ['_displayorcontrol', '_key', '_shift', '_ctrl', '_alt']; if (_key in [28,156]) then {[_key] spawn LIDCLIENT_fnc_PuttyCheck;};";
	class ControlsBackground
	{
		class Back
		{
			...
			style = 0+48;
			text = "\LID\HackSystem\dialog\console_tuppy.paa";
