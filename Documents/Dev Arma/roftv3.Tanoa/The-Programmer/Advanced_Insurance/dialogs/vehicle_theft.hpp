...
class The_Programmer_AdvancedInsurance_VehicleTheft {
   idd = 3900;
   name = "The_Programmer_AdvancedInsurance_VehicleTheft";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       class theft : Life_RscButtonMenuInvisible2Insure
       {
           idc = 3903;
           text = "";
           onbuttonclick = "[] spawn advanced_insurance_fnc_vehicleTheft;";
