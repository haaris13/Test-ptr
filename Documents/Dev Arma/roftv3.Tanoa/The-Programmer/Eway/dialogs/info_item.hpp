...
*/
class Maxence_Eway_Item_Data_Menu {
   idd = 3470;
   name = "Maxence_Eway_Item_Data_Menu";
   movingenable = false;
   ...
   class controls
   {
       ...
       class BoutonSearch : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "closeDialog 0; [(ctrlText 3477)] spawn maxence_eway_fnc_openEway;";
       ...
       class quantitySelected : Life_RscCombo
       {
           ...
           colorselect2right[] = {0,0,0,1};
           colorshadow[] = {1,1,1,0};
           onlbselchanged = "_this spawn maxence_eway_fnc_ewayLbChangedBuyPrice;";
       };
       ...
       class BoutonBuy : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[] spawn maxence_eway_fnc_ewayBuy;";
       ...
       class BoutonMyItems : Life_RscButtonMenu
       {
           idc = 3483;
           text = "";
           onbuttonclick = "closeDialog 0; [1] spawn maxence_eway_fnc_ewayLoadSellingItems;";
       ...
       class BoutonPreview : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[] spawn maxence_eway_fnc_ewayPreview;";
