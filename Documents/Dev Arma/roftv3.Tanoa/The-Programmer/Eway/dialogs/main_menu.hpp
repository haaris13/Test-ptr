...
*/
class Maxence_Eway_Main_Menu {
   idd = 3460;
   name = "Maxence_Eway_Main_Menu";
   movingenable = false;
   ...
   class controls
   {
       ...
       class BoutonMyItems : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[1] spawn maxence_eway_fnc_ewayLoadSellingItems;";
       ...
       class BoutonSearch : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[(ctrlText 3462)] spawn maxence_eway_fnc_openEway;";
