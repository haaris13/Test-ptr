...
*/
class Maxence_Eway_My_Items_Menu {
   idd = 3490;
   name = "Maxence_Eway_My_Items_Menu";
   movingenable = false;
   ...
   class controls
   {
       ...
       class BoutonSearch : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[0,(ctrlText 3493)] spawn maxence_eway_fnc_ewayLoadSellingItems;";
       ...
       class BoutonAddNewItem : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "closeDialog 0; [[]] spawn maxence_eway_fnc_ewayEditItem;";
       ...
       class BoutonDeleteItem : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[] spawn maxence_eway_fnc_ewayTakeBack;";
       ...
       class BoutonEditItem : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "[(call compile format [""%1"",(lbData [3491,(lbCurSel 3491)])])] spawn maxence_eway_fnc_ewayEditItem;";
