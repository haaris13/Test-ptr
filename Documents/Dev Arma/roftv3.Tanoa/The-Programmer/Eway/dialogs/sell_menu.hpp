...
*/
class Maxence_Eway_Sell_Menu {
   idd = 3480;
   name = "Maxence_Eway_Sell_Menu";
   movingenable = false;
   ...
   class controls
   {
       ...
       class BoutonSearch : Life_RscButtonMenu
       {
           idc = -1;
           text = "";
           onbuttonclick = "closeDialog 0; [(ctrlText 3489)] spawn maxence_eway_fnc_openEway;";
       ...
       class durationEdit : Life_RscCombo
       {
           ...
           colorselect2right[] = {0,0,0,1};
           colorshadow[] = {1,1,1,0};
           onlbselchanged = "_this spawn maxence_eway_fnc_ewayLbChangedDaysPrice;";
       };
       ...
       class pricePerItemEdit : Life_RscEdit
       {
           ...
           w = 0.06 * safezoneW;
           h = 0.0192068210422819 * safezoneH;
           onkeyup = "_this spawn maxence_eway_fnc_ewayLbChangedDaysPrice;";
           colorbackground[] = {1,1,1,0};
           colortext[] = {0,0,0,1};
           colorshadow[] = {1,1,1,0};
           shadow = 1;
