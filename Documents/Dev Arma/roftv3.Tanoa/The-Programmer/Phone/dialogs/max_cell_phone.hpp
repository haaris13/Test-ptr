...
class max_cell_phone {
   ...
   class controls
   {
       ...
       class OldMsg : Life_RscButtonMenu
       {
           idc = 9681;
           text = "";
           onbuttonclick = "createDialog ""max_messages_history"";";
       ...
       class RemoveContact : Life_RscButtonMenu
       {
           idc = 4406;
           text = "";
           onbuttonclick = "[] call max_phone_fnc_removeContact;";
           x = 0.289583333333333 * safezoneW + safezoneX;
           y = 0.742803216650899 * safezoneH + safezoneY;
       ...
       class call : Life_RscButtonMenu
       {
           idc = 5041;
           text = "";
           onbuttonclick = "[] spawn max_phone_fnc_sendCall;";
