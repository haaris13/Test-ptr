class Phone_Localization {
    ...
    class STR_END_CALL_PART_1 {
        ...
        es = "<t color='#00981E'>Llamada terminada con :<br/>";
    };
    ...
    class STR_NO_MEDS_CALL {
        ...
        fr = "Aucun médecin s'occupe du standard téléphonique, envoyez un message.";
    ...
    class STR_SEND_TO_MEDS {
        ...
        fr = "Vous avez envoyé aux médecins : %1";
    ...
    class STR_SEND_TO_COPS_AND_MEDS {
        ...
        fr = "Vous avez envoyé aux Policiers et aux médecins: %1";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_18 {
        ...
        fr = "Un médecin récupère déjà les appels vers le %1.";
    ...
    class STR_RECEIVE_MESSAGE_FROM_X_MED {
        ...
        fr = "<t color='#FFCC00'><t size='2'><t align='center'>Demande de Secours !<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Destinataire: <t color='#ffffff'>Médecins<br/><t color='#33CC33'>De: <t color='#ffffff'>%1<br/><t color='#33CC33'>Position: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%3";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_CALLS_ENTREPRISE {
        en = "An employee of this company is already handling calls to the company.";
        fr = "Un employé de cette entreprise s'occupe déjà des appels vers l'entreprise.";
        de = "Ein Angestellter leitet bereits die Anrufe zu seinem Telefon.";
        es = "Un empleado de esta empresa ya esta atendiendo llamadas.";
    };
    ...
    class STR_CANNOT_ADD_SERVICES {
        ...
        es = "No puede hacer llamadas de grupo con números de servicio/empresa !";
    };
