...
class CfgContainers {
	class Filters {
		...
		class nourriture {
			...
			list[] = {
				"redgull","coffee","waterBottle","boutrhum","vinsRouge","sake",
				"tbacon","donuts","rabbitRaw","rabbit",
		...
		class illegal {
			...
			list[] = {
				"goldBar",
				"heroinUnprocessed","heroinProcessed","cannabis","marijuana","cocaineUnprocessed","cocaineProcessed","strawberry_unprocessed","strawberry_processed","khat_unprocessed","khat_processed",
		...
		class chimie {
			...
			list[] = {
				...
				"crack60","crack70","crack80","crack90","crack100","heroin_processed","morphine50","morphine70","morphine90","morphine95","morphineill","krokodil50","krokodil65","krokodil80","krokodil95","krokodilpur",
