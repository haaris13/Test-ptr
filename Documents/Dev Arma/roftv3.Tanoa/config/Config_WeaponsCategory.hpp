...
class CfgWeaponsCategories {
	...
	class Weapons {
		...
		class hlc_rifle_M27IAR { // arme Bratva
			category = "AssaultRifle";
			displayName = "Colt 5,56 mm (noir)";
			dlc = "";
...
class hlc_rifle_416C {
	...
	class hlc_rifle_awcovert {
		...
		//rajout alharis petite mitrailette smg
		class sgun_HunterShotgun_01_sawedoff_F {
			category = "Smg";
			displayName = "Kozlice 12 C";
			dlc = "";
