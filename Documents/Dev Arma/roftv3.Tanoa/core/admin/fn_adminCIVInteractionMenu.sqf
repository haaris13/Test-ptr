...
if (!alive _curTarget) exitWith {
	...
	_Btn2 buttonSetAction "deleteVehicle life_pInact_curTarget; closeDialog 0; ";
...
if ((!_targetZiptied) && (!_targetRestrained)) exitWith {
	...
	if (!_surrender) exitWith {
		...
		_Btn4 buttonSetAction "closeDialog 0; life_pInact_curTarget setVariable ['jail_admin', true, true];";
...
if ((_targetZiptied) || (_targetRestrained)) exitWith {
	...
	_Btn1 buttonSetAction "[life_pInact_curTarget] call admin_fnc_adminUnrestrain; closeDialog 0;";

	if((_curTarget getVariable["Escorting",false])) then {
		_Btn2 ctrlSetText localize "STR_pInAct_StopEscort";
		_Btn2 buttonSetAction "[life_pInact_curTarget] call life_fnc_stopEscorting; [life_pInact_curTarget] call life_fnc_adminCIVInteractionMenu;";
	} else {
