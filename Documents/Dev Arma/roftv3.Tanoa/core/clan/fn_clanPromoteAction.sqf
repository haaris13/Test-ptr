...
if !(_levelMember in _canPromoteList) exitWith {closeDialog 0; hint "Vous ne pouvez pas modifier un joueur ayant ce grade !"; playSound "addItemFailed";};
if !(_levelWant in _canPromoteList) exitWith {hint "Vous n'avez pas le droit d'appliquer ce grade !"; playSound "addItemFailed";};
if (_levelMember > _levelPlayer) exitWith {closeDialog 0; hint "Vous ne pouvez pas modifier le grade d'un membre plus haut que vous !"; playSound "addItemFailed";};
