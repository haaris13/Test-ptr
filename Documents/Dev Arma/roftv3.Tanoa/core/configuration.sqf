...
life_play_time = 0; //c'était sur 0
//Request medic related
life_bledout_time = time;
life_bledout = false;
Life_medic_requested = false; //passé à false 13 juin
life_mode_medic = false;
life_medic_canRevive = -1;
life_mode_medic_civ = objNull;
life_respawn_timer = 180; //Actual time in seconds
life_respawn_timer_med = 360;
life_parts = [0,[]];
...
life_placeables = [
	...
	["coneflash", "coneflash"],
	["routbarr", "routbarr"],
	["droiteinvch", "droiteinvch"],
	["gaucheinvch", "gaucheinvch"],
	["gninvch", "gninvch"],
	["senintrinvch", "senintrinvch"],
...
life_hidden_clothing = [
	...
	"UBM_Mask_Black_01", //rajout alharis masque Bratva 23.04.2022
	"TRYK_kio_balaclava_BLK_ear", //rajout masque Psylium 11.06.200
...
life_combatTime = 0; //rajout alharis
life_firstCombatActive = false; //rajout alharis