...
_colorTitle         = "#FF9933"; // HTML Color Code of the Title Messages (must start with '#' )
...
// First
_title             = format ["Bienvenue %1",name player];
_shorttext         = "Pacific Island";
_posText        = [0.8,0.5,0.4];


_title2         = "Site Web";
_shorttext2     = "https://pacific-island.com/";
_posText2        = [0.8,0.5,0.25];


_title3            = "Teamspeak";
_shorttext3     = "37.187.25.118:8970";
_posText3        = [0.8,0.5,0.25];

/*

_title4      = "Have Fun";
_shorttext4     = "We hope you enjoy your stay!";
