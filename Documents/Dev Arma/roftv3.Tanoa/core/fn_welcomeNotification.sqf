...
_role1names = ["Pacific Island est un mode Roleplay basé sur la simulation d'une vie. N'oubliez pas, ce n'est qu'un jeu!"];
_role2 = "Site et Forum";
_role2names = ["https://pacific-island.com/"];
_role3 = "TeamSpeak";
_role3names = ["ts.pacific-island.com"];
_role4 = "Prénom Nom";
...
_role6 = "Reboot";
_role6names = ["Les reboot sont a 02:00, 08:00, 14:00, 20:00"];
_role7 = "Carte";
_role7names = ["Ouvrez la carte pour voir les raccourcis"];
_role8 = "Level";
