...
/*
	...
	- Usage example
	 ...
	 [this, ""Vendor""] call _fnc_setupNPC;";

	 //Can add everything to this, inc disable damage/simulations
	 //Can also set textures
	 //Icons?

 	[this, ""Taxi Vehicles"", ""NPC""] call life_fnc_setupNPC;


 	[this,"",[],"NPCNAME"] call life_fnc_setupNPC;
*/
