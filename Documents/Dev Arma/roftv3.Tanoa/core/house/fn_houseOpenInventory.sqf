...
if((_chest getVariable ["trunk_in_use",false])) exitWith {hint localize "STR_MISC_VehInvUse"};

_chest setVariable["trunk_in_use",true,true];
if(!createDialog "Dialog_HouseTrunkMenu") exitWith {hint localize "STR_MISC_DialogError";}; //Couldn't create the menu?
...
if(_veh_data select 0 == -1) exitWith {closeDialog 0; _chest setVariable["trunk_in_use",false,true]; hint localize "STR_MISC_NoStorageVeh";};
