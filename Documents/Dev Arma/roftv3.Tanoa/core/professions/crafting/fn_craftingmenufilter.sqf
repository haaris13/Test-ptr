...
switch (_filter) do {
	...
	case 1 : {_profession = ["Gathering","prof_gathering"]};
	...
	case 5 : {_profession = ["Exploitant","prof_agricole"]};
	case 6 : {_profession = ["Livreur","prof_livraison"]};
	case 7 : {_profession = ["Interim","prof_interim"]};
