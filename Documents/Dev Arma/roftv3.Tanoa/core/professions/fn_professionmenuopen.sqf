...
{CONTROL(12000,_x) progressSetPosition (1 / (1000 / 1));}forEach [12004,12009,120014,120019,120024,120029,120034,120039];
...
} forEach ["prof_craft","prof_mining","prof_gathering","prof_treasure","prof_chimie","prof_livraison","prof_agricole","prof_interim"];
