/*
	File: fn_radioProfileAjouter.sqf
...
if (life_profile_inCur) exitWith { hint "Impossible pour le moment !"};
if (count _currentProfiles >= 4) exitWith { hint "Vous pouvez crée 4 profiles Maximum !";};
...
_button buttonSetAction "[] spawn life_fnc_radioProfileAjouterV;";
