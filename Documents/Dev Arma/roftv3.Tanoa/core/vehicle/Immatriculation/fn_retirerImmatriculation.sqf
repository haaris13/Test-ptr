...
if (getNumber(missionConfigFile >> "CfgImmatriculationTags" >> (typeOf _vehicle) >> "isIllegal") isEqualTo 1 || (_vehicle getVariable ["immatriculation","illegal"] isEqualTo "illegal")) exitWith {hint "Il n'y a pas de plaques d'immatriculation sur ce véhicule !"};
...
if !(ITEM_VALUE("toolKit") >= 1) exitWith {hint "Trousse à outils nécessaire !";};
