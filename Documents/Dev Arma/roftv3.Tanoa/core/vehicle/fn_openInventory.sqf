...
if(!createDialog "TrunkMenu") exitWith {_vehicle setVariable["trunk_in_use",false,true];hint localize "STR_MISC_DialogError";}; //Couldn't create the menu?
...
*/
if (_vehicle isKindOf "Box_IND_Grenades_F" OR _vehicle isKindOf "B_supplyCrate_F" OR _vehicle isKindOf "CargoNet_01_box_F" OR _vehicle isKindOf "C_supplyCrate_F" ) then {
	private["_mWeight"];
	_mWeight = 0;
...
if(_veh_data select 0 == -1) exitWith {closeDialog 0; _vehicle setVariable["trunk_in_use",false,true]; _vehicle setVariable["trunk_in_use",false,true]; hint localize "STR_MISC_NoStorageVeh";};
