...
class Life_RscStructuredTextMinimum {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
	...
	w = 0.1;
	text = "";
	size = "(			(			(			((safezoneW / safezoneH) min 1.0) / 1.2) / 25) * 1)";
	colorText[] = {1, 1, 1, 1.0};
	shadow = 1;
...
class Life_RscLittleButtonMenu : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02";
	default = 0;
...
class Life_RscButtonMenuFixLater : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class Life_RscButtonMenuBasic : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "2";
	default = 0;
...
class Life_RscProgressVertical 
{
	type = 8;
	style = "0x01";
	x = 0.344;
...
class Life_RscEditLarge : Life_RscEdit {
