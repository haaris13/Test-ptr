class PerkDialog
{
	...
	class Controls
	{
		...
		class ButtonT11: Life_RscButtonMenu
		{
			idc = 17011;
			text = "Tier 11"; //Overview
			onButtonClick = "[11] call life_fnc_perkFilterTier;";
			x = 0.278281 * safezoneW + safezoneX;
		...
		class ButtonT12: Life_RscButtonMenu
		{
			idc = 17012;
			text = "Tier 12"; //Overview
			onButtonClick = "[12] call life_fnc_perkFilterTier;";
			x = 0.319531 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT13: Life_RscButtonMenu
		{
			idc = 17013;
			text = "Tier 13"; //Overview
			onButtonClick = "[13] call life_fnc_perkFilterTier;";
			x = 0.360781 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT14: Life_RscButtonMenu
		{
			idc = 17014;
			text = "Tier 14"; //Overview
			onButtonClick = "[14] call life_fnc_perkFilterTier;";
			x = 0.402031 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		...
		class ButtonT15: Life_RscButtonMenu
		{
			idc = 17015;
			text = "Tier 15"; //Overview
			onButtonClick = "[15] call life_fnc_perkFilterTier;";
			x = 0.443281 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT16: Life_RscButtonMenu
		{
			idc = 17016;
			text = "Tier 16"; //Overview
			onButtonClick = "[16] call life_fnc_perkFilterTier;";
			x = 0.484531 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT17: Life_RscButtonMenu
		{
			idc = 17017;
			text = "Tier 17"; //Overview
			onButtonClick = "[17] call life_fnc_perkFilterTier;";
			x = 0.525781 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT18: Life_RscButtonMenu
		{
			idc = 17018;
			text = "Tier 18"; //Overview
			onButtonClick = "[18] call life_fnc_perkFilterTier;";
			x = 0.566985 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT19: Life_RscButtonMenu
		{
			idc = 17019;
			text = "Tier 19"; //Overview
			onButtonClick = "[19] call life_fnc_perkFilterTier;";
			x = 0.608206 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
		};
		class ButtonT20: Life_RscButtonMenu
		{
			idc = 17020;
			text = "Tier 20"; //Overview
			onButtonClick = "[20] call life_fnc_perkFilterTier;";
			x = 0.649427 * safezoneW + safezoneX;
			y = 0.280 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.022 * safezoneH;
