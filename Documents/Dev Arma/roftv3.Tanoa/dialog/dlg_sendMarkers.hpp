class SendMarkersDialog
{
	...
	class controlsBackground
	{
		class RscTitleBackground: Life_RscText
		{
			...
			text = "Partage D'Information"; //--- ToDo: Localize;
	...
	class Controls
	{
		...
		{
			idc = 18101;
			onLBSelChanged = "_this call life_fnc_lbChangeSendMarkers";
			rowHeight = 0.09;
		...
		{
			onButtonclick = "[] spawn life_fnc_sendMarkers;";
			idc = 18103;

			text = "Partager"; //--- ToDo: Localize;
