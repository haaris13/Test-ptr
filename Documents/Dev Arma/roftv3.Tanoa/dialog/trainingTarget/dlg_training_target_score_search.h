...
class Training_Target_Score_Search {
	idd = 2820;
	name= "Training_Target_Score_Search";
	movingEnable = false;
	...
	class controls {
		...
		class InfoMsg: Life_RscStructuredText
		{
			...
			text = "Vous pouvez rechercher par pseudo"; //--- ToDo: Localize;
		...
		{
			onButtonClick = "[] spawn life_fnc_targetTrainingScoresSearchAction";
